...
if("TRUE" STREQUAL "TRUE")
  set(swift_moveit_config_SOURCE_PREFIX /root/catkin_ws/src/swift_moveit_config)
  set(swift_moveit_config_DEVEL_PREFIX /root/catkin_ws/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'swift_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/swift_moveit_config/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(swift_moveit_config_EXPORTED_TARGETS ${${swift_moveit_config_dep}_EXPORTED_TARGETS})
endforeach()
